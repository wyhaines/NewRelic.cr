@[Link(ldflags: "-static -L#{__DIR__}/../../c-sdk -lnewrelic")]

# This implements the low level interface between Crystal and the
# C SDK. While it can be utilized directly, with usage semantics
# identical to that of the C SDK, the NewRelic module is the preferred
# interface, as it provides a more idiomatic, developer-friendly interface.
lib NewRelicExt
  ...
  type TransactionTracerConfigTDatastoreReporting = X_NewrelicTransactionTracerConfigTDatastoreReporting
